...
class database
{
	...
	public function getliveproduct($day)
	{
		...
		$con=database::connect();
			$res=mysql_query("select pt.*,b.* from product_tbl as pt,cattime_tbl as ct,category_tbl as cat,bid_tbl as b,bidconfirm_tbl as bidconf where ct.cattime_day='$day' and ct.fk_cat_id=cat.cat_id and pt.fk_cat_id=cat.cat_id and product_status=1 and b.fk_product_id=pt.product_id and bidconf.confirm_bid_date='$date' and bidconf.fk_bid_id=b.bid_id",$con);
			return $res;
			database::disconnect();
	}
