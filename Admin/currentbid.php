...
<html lang="en">
  <head>
    ...
    <title>Current Bid Details </title>
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Current Bid Details</h1></center>
    <form action="mail1.php" method="post">
      <?php
        ...
        echo'<button class="btn btn-danger" type="submit" name="sendmail" ><span>Mail All</span></button>';
    }
?>
...
<table class="table table-striped table-advance table-hover" id="dataTable">
    <thead>
      ...
      <th><i class="icon_document_alt" ></i> Name</th>
             ...
             $day=date("D");
                $res=$obj->getliveproduct($day);
                    ...
                    while($row=mysql_fetch_assoc($res))
                    {
                      ...
                      <td><a href="viewcurrentbid.php?product_id='.$product_id.'" class="btn btn-success"><span class=" glyphicon glyphicon-eye-open" arial-hidden="true"></span></a>
                      </td>
                      </tr>';
